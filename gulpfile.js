...
const resourcesInfo = {
    styles:{
        ...
        admin:{
            srcDir:'./sources/scope-admin/scss/',
            srcListFile:'./sources/scope-admin/scss/**/*.scss',
            distDir:'./assets/scope-admin/css/',
        },
        editor:{
            srcDir:'./sources/scope-editor/scss/',
            srcListFile:'./sources/scope-editor/scss/**/*.scss',
...
/** 3.1. Distribute all prelib styles and scripts */
...
/** 3.2. Distribute all styles and scripts for frontend display */
/** 3.2.1. Distribute all styles files - SCSS to CSS === **/
...
/**=== 3.2.2. Distribute all script files - JS ES6 to Vanilla JS === **/
...
/***************************/
/** 3.2. Distribute admin styles and scripts */
/** 3.2.1. Distribute admin style */
gulp.task( 'distribute-all-admin-styles', distribute_all_admin_styles );

function distribute_all_admin_styles( done ){
    /** 1. Distribute all frontend display SCSS to CSS in beauty format */
    distribute_all_scss_to_css_beauty_format(
        resourcesInfo.styles.admin.srcListFile,
        resourcesInfo.styles.admin.distDir
    );

    done();
};//distribute_all_frontend_styles

/** 3.2.2. Distribute admin script */

gulp.task( 'distribute-all-admin-scripts', distribute_all_admin_scripts_recursively );

function distribute_all_admin_scripts_recursively( done ){
    ...
    /** 1. Distribute all JS files in the outer directory */
    distribute_all_modern_js_to_vanilla_js(
        resourcesInfo.scripts.admin.srcDir,
        resourcesInfo.scripts.admin.srcListFile,
        resourcesInfo.scripts.admin.distDir
    );

    /** 2. Iterate through each sub directory, and distribute all JS files */
    getAllSubDirectories( resourcesInfo.scripts.admin.srcDir )
        .then( subDirectories => ( 
            function( subDirectories ){ 
                    const subDirList = Object.values( subDirectories );// OK
...
}//distribute_all_admin_scripts_recursively

/*****************************************************************/
/** 4. Helper functions for (3) category ***/

/** 4.1. Distribute all SCSS to CSS */
/** 4.1.1. Helper functions Distribute all styles files - SCSS to CSS **/
...
/** 4.1.2. Distribute single file SCSS to CSS */
...
/** 4.1.3. Distribute all SCSS to minified CSS */
...
/** 4.2. Distribute JS scripts to traditional JS */
/** Helper functions Distribute all scripts files - JS ES6 to Vanilla JS === **/
/** 4.2.1. Distribute a single modern JS file to vanilla JS file */
...
/** 4.2.2. Distribute all modern JS files to vanilla JS */
...
gulp.task(
    'distribute-all-admin-resources',
    gulp.series( 
...
/** 4.3. Distribute all frontend resources **/
...
/** 4.4. Distribute all editor resources **/
