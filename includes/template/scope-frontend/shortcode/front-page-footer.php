...
<div id="dutapod-footer-outer-container" class="dutapod-footer-outer-container">
    <div id="dutapod-footer-container" class="dutapod-footer-container">
        <div class="grid grid-cols-12 gap-12 justify-evenly inner-footer-container">
    ...
    <div id="dutapod-footer-bottom-container" class="dutapod-footer-bottom-container">
        <div class="grid grid-cols-12 gap-12 justify-evenly dutapod-footer-bottom-inner-container">            
            <div class="dutapod-footer__payment col-start-9 col-span-4">
